<x-layout :title="$title">
    <div class="mt-4">
        ...
        <form method="POST" action="{{route('nhanvien.update',[$nhanvien->maNV])}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3 mt-3 row justify-content-center">
                ...
                <div class="col">
                    <input type="text" class="form-control shadow-sm" id="tenNV" name="tenNV"
                           placeholder="Tên nhân viên..." value="{{$nhanvien->tenNV}}">
                </div>
            </div>
            ...
            <div class="mb-3 mt-3 row justify-content-center">
                ...
                <div class="col">
                    <input type="text" class="form-control shadow-sm" id="userName" name="userName"
                           placeholder="Username..." value="{{$nhanvien->username}}">
                </div>
            </div>
            ...
            <div class="mb-3 mt-3 row justify-content-center">
                ...
                <div class="col">
                    <input type="text" class="form-control shadow-sm" id="password" name="password"
                           placeholder="Password..." value="{{$nhanvien->password}}">
                </div>
            </div>
            ...
            <div class="mb-3 mt-3 row justify-content-center">
                ...
                <div class="col">
                    <select class="form-select shadow-sm w-25" name="gioiTinh" id="gioiTinh">
                        <option @if($nhanvien->gioiTinh==0) selected @endif value="0">Nam</option>
                        <option @if($nhanvien->gioiTinh==1) selected @endif value="1">Nữ</option>
                    </select>
                </div>
            </div>
                ...
                <div class="col">
                    <select class="form-select shadow-sm w-25" name="maPhong" id="maPhong">
                        @foreach($phongbans as $phongban)
                            <option @if($phongban->maPhong == $nhanvien->maPhong ) selected @endif value="{{$phongban->maPhong}}">{{$phongban->tenPhong}}</option>
                        @endforeach()
                    </select>
                </div>
            </div>
                ...
                <div class="col">
                    <select class="form-select shadow-sm w-25" name="maCV" id="maCV">
                        @foreach($chucvus as $chucvu)
                            <option @if($chucvu->maCV == $nhanvien->maCV ) selected @endif value="{{$chucvu->maCV}}">{{$chucvu->chucVu}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="mb-3 mt-3 row justify-content-center">
                ...
                <div class="col">
                    ...
                    <div class="mt-3 border border-sakura text-center" style="width: 300px">
                        <img src="{{asset('storage/'.$nhanvien->hinh)}}" class="img-fluid" alt="...">
