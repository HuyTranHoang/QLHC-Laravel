...
<nav class="navbar navbar-dark container-fluid bg-sakura">
    <div class="container position-relative"><a class="navbar-brand" href="#"><i
                class="fa-duotone fa-rocket-launch"></i> Aptech - C2206L </a>
            ...
            <form method="POST" action="/authenticate">
                ...
                <div class="col mt-3">
                    <div class="footer-login">
                        <p class="text-muted">Chưa có tài khoản? <a href="#" class="text-decoration-none">Đăng ký</a>
                            ngay</p>
                    </div>
                </div>
            </form>
